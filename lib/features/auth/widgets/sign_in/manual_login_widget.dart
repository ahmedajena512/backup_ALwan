          ...
          children: [
            ...
            Theme(
              ...
              child: CustomTextFieldWidget(
                ...
                prefixIcon: authController.isNumberLogin ? null : Icons.phone,
            ...
            Container(
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xFF33b0e0), width: 2),
                color: Colors.white,
              ),
              child: CustomButtonWidget(
                height: isDesktop ? 50 : null,
                width: isDesktop ? 250 : null,
                buttonText: 'guest_mode'.tr,
                radius: 50,
                isBold: true,
                transparent: true,
                textColor: const Color(0xFF33b0e0),
                onPressed: () {
