                  ...
                  SizedBox(
                    ...
                    child: GetBuilder<LocationController>(
                      builder: (locationController) {
                        return AddressHelper.getAddressFromSharedPref() != null
                            ? InkWell(
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      CustomToolTip(
                                        message:
                                            'please_setup_your_location_to_view_available_restaurants_and_foods_in_your_area'
                                                .tr,
                              ...
                              child: MenuButton(
                                ...
                                onTap: () {
                                  if (AddressHelper.getAddressFromSharedPref() !=
                                      null) {
                                    Get.toNamed(
                                      RouteHelper.getFavouriteScreen(),
                                    );
                                  } else {
                                    showCustomSnackBar(
