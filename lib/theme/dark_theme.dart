...
ThemeData dark = ThemeData(
  ...
  primaryColor: const Color(0xFF33b0e0),
  secondaryHeaderColor: const Color(0xFF84d46e),
  ...
  textButtonTheme: TextButtonThemeData(
    style: TextButton.styleFrom(foregroundColor: const Color(0xFF33b0e0)),
  ),
  colorScheme:
      const ColorScheme.dark(
            primary: Color(0xFF33b0e0),
            tertiary: Color(0xFF84d46e),
            tertiaryContainer: Color(0xff171DB6),
            secondary: Color(0xFF84d46e),
          )
