...
Future<Map<String, Map<String, String>>> init() async {
  ...
  ///Interfaces
  LocationRepoInterface locationRepoInterface = LocationRepo(
    apiClient: Get.find(),
  );
  ...
  AddressRepoInterface addressRepoInterface = AddressRepo(
    apiClient: Get.find(),
  );
  ...
  CuisineRepositoryInterface cuisineRepositoryInterface = CuisineRepository(
    apiClient: Get.find(),
  );
  Get.lazyPut(() => cuisineRepositoryInterface);
  CuisineServiceInterface cuisineServiceInterface = CuisineService(
    cuisineRepositoryInterface: Get.find(),
  );
  ...
  ProductRepositoryInterface productRepositoryInterface = ProductRepository(
    apiClient: Get.find(),
  );
  Get.lazyPut(() => productRepositoryInterface);
  ProductServiceInterface productServiceInterface = ProductService(
  ...
  InterestRepositoryInterface interestRepositoryInterface = InterestRepository(
    apiClient: Get.find(),
  );
  Get.lazyPut(() => interestRepositoryInterface);
  InterestServiceInterface interestServiceInterface = InterestService(
    interestRepositoryInterface: Get.find(),
  );
  ...
  RestaurantServiceInterface restaurantServiceInterface = RestaurantService(
    restaurantRepositoryInterface: Get.find(),
  );
  ...
  DineInRepositoryInterface dineInRepositoryInterface = DineInRepository(
    apiClient: Get.find(),
  );
  Get.lazyPut(() => dineInRepositoryInterface);
  DineInServiceInterface dineInServiceInterface = DineInService(
    dineInRepositoryInterface: Get.find(),
  );
