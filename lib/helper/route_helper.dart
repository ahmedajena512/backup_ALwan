...
class RouteHelper {
  ...
  static const String recentlyViewedRestaurants =
  ...
  static String getRestaurantRoute(
    int? id, {
    String? slug,
    bool fromDinIn = false,
  }) {
  ...
  static String getPopularFoodRoute(
    bool isPopular, {
    bool fromIsRestaurantFood = false,
    int? restaurantId,
  }) {
  ...
  static String getReviewRoute(RateReviewModel rateReviewModel) {
    String data = base64Encode(
      utf8.encode(jsonEncode(rateReviewModel.toJson())),
    );
  ...
  static String getCartRoute({
    bool fromReorder = false,
    bool fromDineIn = false,
  ...
  static String getRestaurantReviewRoute(
    ...
    String data = base64Url.encode(
      utf8.encode(jsonEncode(restaurant.toJson())),
    );
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
      ...
      page: () {
        ...
        if (Get.parameters['link'] != 'null') {
          List<int> decode = base64Decode(
            Get.parameters['link']!.replaceAll(' ', '+'),
          );
    ...
    GetPage(
      name: coupon,
      page: () => getRoute(
        CouponScreen(fromCheckout: Get.parameters['fromCheckout'] == 'true'),
      ),
    ),
    GetPage(
      name: notification,
      ...
      page: () {
        return getRoute(
          OrderSuccessfulScreen(
            ...
            totalAmount: Get.parameters['amount'] != null
                ? double.parse(Get.parameters['amount']!)
                : 0.0,
            contactPersonNumber:
    ...
    GetPage(
      name: payment,
      page: () {
        OrderModel data = OrderModel.fromJson(
          jsonDecode(
            utf8.decode(
    ...
    GetPage(
      name: itemCampaign,
      page: () => getRoute(const ItemCampaignScreen()),
    ),
    GetPage(
      name: support,
    ...
    GetPage(
      name: rateReview,
      page: () {
        RateReviewModel data = RateReviewModel.fromJson(
          jsonDecode(
            utf8.decode(
              base64Decode(Get.parameters['data']!.replaceAll(' ', '+')),
            ),
    ...
    // Recently Viewed Restaurants
    GetPage(
      name: recentlyViewedRestaurants,
      page: () => getRoute(
        const AllRestaurantScreen(
          isPopular: false,
    ...
    GetPage(
      ...
      page: () => getRoute(
        MapViewScreen(
          fromDineInScreen: Get.parameters['from_dine_in_screen'] == 'true',
        ),
      ),
    ),
    ...
    GetPage(
      ...
      page: () {
        ...
        PricingViewModel pricingViewBody = PricingViewModel.fromJson(
          jsonDecode(utf8.decode(decode2)),
        );
